     ...
     <br><br><br><br><br>
      <center>
        <%
            ...
            String hashkeyword = request.getParameter("hashkeyword");
        ...
        try {
            ...
            rs = st.executeQuery("select * from upload where filename='"+filename+"' and hash='"+hashkeyword+"'");
...
<tr>
      ...
      <th><font color="black"><textarea><%=rs.getString(2)%></textarea></th>
       <td><a href="user_download2.jsp?filename=<%=rs.getString(1)%>&keyword=<%=rs.getString(4)%>&owner=<%=rs.getString(3)%>&hashkeyword=<%=rs.getInt("hash")%>"><font color="#007ebf">Download</a> </td>
 </tr> 
                 <br>
