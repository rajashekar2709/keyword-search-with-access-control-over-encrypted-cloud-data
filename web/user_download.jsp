...
<script src="js/Myriad_Pro_300.font.js" type="text/javascript"></script>
     ...
     <%
        ...
        <script>alert('Error in file download');</script>
        <%}
...
<div class="tail-top">
  <div class="tail-bottom">
    <div class="body-bg">
      ...
      <br><br><br><br><br>
      <center>
<p><font color="#00768e" size="5">Search Files</font></p><br>
         <form name="myform" action="user_download1.jsp" method="post">
         <table border="0" >

         <tr><td><font color="black">Enter File Name</td><td><input type="text" name="filename" required="" /></td></tr>
         <tr><td><font color="black">Enter Hash Keyword</td><td><input type="text" name="hashkeyword" required="" /></td></tr>
