...
<div class="tail-top">
  <div class="tail-bottom">
    <div class="body-bg">
      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li class="m4"><a href="cloud.jsp" class="active">Cloud Server</a></li>
      ...
      <br><br><br><br><br>
      <center>
        <p><font color="#00768e" size="5"> Cloud Login</font></p><br>
         <form name="myform" action="cloudact.jsp" method="post">
         <table border="0" >
