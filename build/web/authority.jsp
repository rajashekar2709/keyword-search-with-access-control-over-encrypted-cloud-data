...
<div class="tail-top">
  <div class="tail-bottom">
    <div class="body-bg">
      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li class="m3"><a href="authority.jsp" class="active">Authority</a></li>
      ...
      <br><br><br><br><br>
      <center>
        <p><font color="#00768e" size="5"> Authority Login</font></p><br>
         <form name="myform" action="authorityact.jsp" method="post">
         <table border="0" >
