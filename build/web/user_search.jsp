...
<script src="js/Myriad_Pro_300.font.js" type="text/javascript"></script>
   ...
   <%
        ...
        <script>alert('search request sent to cloud');</script>
        <%}
      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li class="m2"><a href="user_search.jsp"  class="active">Search Files</a></li>
...
<p><font color="#00768e" size="5">Search Files</font></p><br>
         <form name="myform" action="user_search1.jsp" method="post">
         <table border="0" >

         <tr><td><font color="black">Enter Keyword</td><td><input type="text" name="keyword" required="" /></td></tr>
