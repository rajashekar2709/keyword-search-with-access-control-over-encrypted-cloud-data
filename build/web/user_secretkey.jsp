...
<script src="js/Myriad_Pro_300.font.js" type="text/javascript"></script>
  ...
  <%
        ...
        <script>alert('User Login Success Verify secret Key');</script>
        <%}
            if (request.getParameter("msg1") != null) {%>
        <script>alert('secret Key verification failed');</script> 
...
<div class="tail-top">
  <div class="tail-bottom">
    <div class="body-bg">
      ...
      <br><br><br><br><br>
      <center>
<p><font color="#00768e" size="5"> User Secret Key Verification</font></p><br>
         <form name="myform" action="user_secretkeyact.jsp" method="post">
         <table border="0" >

         <tr><td><font color="black"> Secret key</td><td><input type="text" name="secretkey" required="" /></td></tr>
